...
class TestFirstToN:
    ...
    def test_no_scores_produces_no_winner(self):
        game = FirstToN()
        result = game.process_scores([], {"scores_to_win": 3}, {}, _TEST_TIME)
    ...
    def test_exact_threshold_declares_winner(self):
        ...
        result = FirstToN().process_scores(scores, {"scores_to_win": 3}, {}, _TEST_TIME)
    ...
    def test_multiplayer_team_aggregation(self):
        ...
        result = FirstToN().process_scores(scores, {"scores_to_win": 2}, {}, _TEST_TIME)
    ...
    def test_scores_dict_returned(self):
        ...
        result = FirstToN().process_scores(scores, {"scores_to_win": 1}, {}, _TEST_TIME)
